...
df = readSave.read_csv_data("/Users/amine/Desktop/Spark-Recommendation-System/data/en.openfoodfacts.org.products.csv.gz")
...
df_with_embeddings = fetaure.addEmbedingColumn(df_with_tokens, "/Users/amine/Desktop/Spark-Recommendation-System/models/custom_word2vec_model")

# save the final dataframe with embeddings
df_with_embeddings.write.mode("overwrite").parquet("/Users/amine/Desktop/Spark-Recommendation-System/data/final_data_with_embeddings.parquet")
